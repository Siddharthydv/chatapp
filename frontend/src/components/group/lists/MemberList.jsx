    ...
    return List?(
        <div className="flex flex-col justify-between w-3/12 h-full fixed top-1 right-0 bottom-10 border-l z-50 box-border p-2  bg-neutral-900">
            <div className="border h-3/4">
                <svg className="w-6 h-6" onClick={()=>{setListVisibilty(prev=>!prev)}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M512 256A256 256 0 1 0 0 256a256 256 0 1 0 512 0zM271 135c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-87 87 87 87c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0L167 273c-9.4-9.4-9.4-24.6 0-33.9L271 135z"/></svg>
