...
export default function Sidebar()
{
  ...
  const friendlist=async()=>{
   ...
   return  <div className="bg-[#3E92CC] h-full  flex justify-center items-center border-2 rounded-md">
  <div className="ml-4 mr-4 flex w-16 flex-col items-center space-y-10 py-6">
